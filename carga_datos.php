...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!is_numeric($year) || $year < 1973 || $year > date('Y')) {
        $message = 'Por favor, complete con un año válido.';
        error_log("DEBUG: Año no válido");
    } 
}
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control search-secondary" placeholder="Ingrese el número" inputmode="numeric" pattern="[0-9]*" maxlength="20" required>
                                </div>
                                <div class="col-md-4">
                                    <label for="year" class="form-label">Año</label>
                                    <input type="text" name="year" id="year" class="form-control" placeholder="Seleccione el año" required>
                                </div>
                                <div class="col-12">
